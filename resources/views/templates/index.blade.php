        ...
        <div class="mx-auto flex h-[72px] max-w-[1240px] items-center justify-between px-5 sm:px-6 lg:px-8">
            ...
            <div class="hidden items-center gap-1 md:flex">
                ...
                <a href="{{ route('templates.index') }}"
                    class="rounded-lg bg-blue-50 px-3.5 py-2 text-[13px] font-medium text-blue-600 transition hover:bg-blue-100">Template
                    Jurnal</a>
        ...
        <div id="mobile-menu"
            ...
            <div class="flex flex-col gap-1 pt-3">
                ...
                <a href="{{ route('pricing') }}"
                    ...
                    Harga</a>
                <a href="{{ route('templates.index') }}"
                    class="rounded-xl bg-blue-50 px-3 py-3 text-sm font-medium text-blue-600 transition hover:bg-blue-100">Template
                    Jurnal</a>
                <a href="{{ route('welcome') }}#faq"
