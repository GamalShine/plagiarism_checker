...
<nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto pc-scrollbar">
    ...
    <a href="{{ route('user.dashboard') }}" @click="sidebarOpen = false"
        class="pc-nav-item uppercase {{ request()->routeIs('user.dashboard') ? 'active' : '' }}">
    ...
    <a href="{{ route('user.plagiarism.index') }}" @click="sidebarOpen = false"
        class="pc-nav-item uppercase {{ request()->routeIs('user.plagiarism.*') ? 'active' : '' }}">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('user.history.index') }}" @click="sidebarOpen = false"
        class="pc-nav-item uppercase {{ request()->routeIs('user.history.*') ? 'active' : '' }}">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('user.settings.index') }}" @click="sidebarOpen = false"
        class="pc-nav-item uppercase {{ request()->routeIs('user.settings.*') ? 'active' : '' }}">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('admin.dashboard') }}" @click="sidebarOpen = false"
        class="pc-nav-item uppercase {{ request()->routeIs('admin.*') ? 'active' : '' }}">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
